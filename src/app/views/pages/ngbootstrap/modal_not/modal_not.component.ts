...
@Component({
	selector: 'kt-modal_not',
	templateUrl: './modal_not.component.html',
...
export class ModalComponent_not implements OnInit {
	...
	update_meeting() {
		...
		if (this.form1.invalid) {
			...
			var val = {
				...
				group_name: this.selectedSlide,
				meeting_no: Number(this.meeting_no),
				meeting_date: this.dateValue,
				meeting_mem_no: this.meeting_mem_no,
				bus_table: this.bus_table,
				objgroup_meeting: "ob",
				meeting_type_name: this.meetingValue,
				dep_name: this.selecteddepartment.dep_name,
				dep_id:this.selecteddepartment.dep_id,
				content:  this.meeting_type.find(e => e.meeting_type_name == this.meetingValue).content_label,
				meeting_loc: this.meeting_type.find(e => e.meeting_type_name == this.meetingValue).meeting_loc_label,
				impor_recomm:  this.meeting_type.find(e => e.meeting_type_name == this.meetingValue).recommendation_label,
				meeting_type_id: Number( this.meeting_type.find(e => e.meeting_type_name == this.meetingValue).meeting_type_id,),
			};
