...
@Component({
	...
	selector: 'kt-show_lib-list',
	templateUrl: './show_lib-list.html',
	changeDetection: ChangeDetectionStrategy.OnPush
	
	/*,providers: [DepartmentDataService]*/
})
export class Show_libListComponent implements OnInit, OnDestroy {
	// Table fields


    Element1: [{ id: "1" },
        { id: "2" }];
	displayedColumns = ['lib_id', 'lib_rec_no', 'lib_book_name', 'lib_author_name', 'lib_date', 'lib_page_no','actions'];
