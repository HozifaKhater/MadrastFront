...
deleteCustomers() {
		for (let i = 0; i < this.selection.selected.length; i++) {
			...
			this.Evaluation_itemsDataService.deleteEvaluation_items(Number(this.selection.selected[i].evaluation_id)).subscribe(res => {
				this.get_Evaluationitems()
	...
	ngOnInit() {
		...
		this.Evaluation_itemsDataService.bClickedEvent
