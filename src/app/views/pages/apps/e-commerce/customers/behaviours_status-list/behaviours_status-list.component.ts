...
@Component({
	...
	selector: 'kt-behaviours_status-list',
	templateUrl: './behaviours_status-list.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush
	
	/*,providers: [DepartmentDataService]*/
})
export class behaviours_statusListComponent implements OnInit, OnDestroy {
	// Table fields


    Element1: [{ id: "1" },
        { id: "2" }];
	displayedColumns = ['select', 'id', 'status_type', 'reasons','civil_id','student_name','actions'];
...
/*	dataSource: [{ "dep_id": 1, "dep_name": "main dep", "dep_desc": "asdasd", "dep_supervisor_id": 0, "dep_supervisor_name": "1", "parent_id": 1 }];*/
	...
	get_data() {
       ...
       // this.dataSource = new MatTableDataSource([])
		    this.behaviours_statusDataService.get_behaviours_status().subscribe((data:any) => this.ELEMENT_DATA = data.data,
	...
	data_info: any[];
	edit_subject(behaviours_status: behaviours_status ) {
	...
	delete_subject(behaviours_status: behaviours_status) {
