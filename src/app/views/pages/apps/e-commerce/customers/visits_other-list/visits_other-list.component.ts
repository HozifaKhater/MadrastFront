...
@Component({
	selector: 'kt-visits_other-list',
    templateUrl: './visits_other-list.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush
})
export class visits_otherComponent implements OnInit, OnDestroy {
	// Table fields


    Element1: [{ id: "1" },
        { id: "2" }];
	displayedColumns = ['select', 'visit_id', 'topic', 'actions'];
