...
export class DisonlevelListComponent implements OnInit, OnDestroy {
	...
	Element1: [{ id: "1" },
		{ id: "2" }];
	displayedColumns = ['lev_id', 'lev_name', 'num_classes','num_students'];
	...
	get_levels() {
		...
		this.LevelsDataService.get_levels_stats().subscribe(data => this.ELEMENT_DATA = data,
			error => console.log(error),
			() => {this.dataSource.data = this.ELEMENT_DATA;
				this.ELEMENT_DATA;
				this.LevelsDataService.total_students= this.dataSource.data[0].total_students;
				this.LevelsDataService.total_classes= this.dataSource.data[0].total_classes}
		);
	}
	/**
