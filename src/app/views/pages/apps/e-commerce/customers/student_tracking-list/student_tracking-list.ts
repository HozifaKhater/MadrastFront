...
@Component({
	...
	selector: 'kt-student_tracking-list',
	templateUrl: './student_tracking-list.html',
	changeDetection: ChangeDetectionStrategy.OnPush


})
export class student_trackingListComponent implements OnInit, OnDestroy {
	// Table fields
    ...
    get_data(class_id,date) {
        ...
        this.student_trackingDataService.get_student_tracking(val).subscribe((data: any) => {console.log("data",data.data);this.ELEMENT_DATA = data.data},
            error => console.log(error),
            () => this.dataSource.data = this.ELEMENT_DATA);
        console.log("zzz", this.ELEMENT_DATA);}
	/**
	...
	ngOnInit() {
        this.student_trackingDataService.bClickedEvent
