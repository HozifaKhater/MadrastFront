...
@Component({
	...
	selector: 'kt-show-users_priv-list',
	templateUrl: './show_users_priv-list.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush
	
	/*,providers: [DepartmentDataService]*/
})
export class Showusers_privComponent implements OnInit, OnDestroy {
	// Table fields


    Element1: [{ id: "1" },
        { id: "2" }];
	displayedColumns = ['user_id', 'emp_name', 'job_name'];
