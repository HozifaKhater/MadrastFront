...
@Component({
	...
	selector: 'kt-show-visits-list',
	templateUrl: './show_visits-list.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush
	
	/*,providers: [DepartmentDataService]*/
})
export class ShowvisitsComponent implements OnInit, OnDestroy {
	// Table fields


    Element1: [{ id: "1" },
        { id: "2" }];
	displayedColumns = ['visit_id', 'visit_date','visit_type_name'];
