...
@Component({
	...
	selector: 'kt-show-group_meeting-list',
	templateUrl: './show-group-meeting-list.html',
	changeDetection: ChangeDetectionStrategy.OnPush
	
	/*,providers: [DepartmentDataService]*/
})
export class ShowGroupmeetingListComponent implements OnInit, OnDestroy {
	// Table fields


    Element1: [{ id: "1" },
        { id: "2" }];
	displayedColumns = ['group_id', 'meeting_date', 'group_name'];
...
/*	dataSource: [{ "dep_id": 1, "dep_name": "main dep", "dep_desc": "asdasd", "dep_supervisor_id": 0, "dep_supervisor_name": "1", "parent_id": 1 }];*/
	...
	ngOnInit() {
		...
		this.Group_meetingDataService.bClickedEvent
