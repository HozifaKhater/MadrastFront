...
// Components
import { CustomerEditDialogComponent } from '../../apps/e-commerce/customers/customer-edit/customer-edit.dialog.component';
...
@Component({
	...
	selector: 'kt-show-matters-list',
	templateUrl: './show-student-matters-list.html',
	changeDetection: ChangeDetectionStrategy.OnPush
	
	/*,providers: [DepartmentDataService]*/
})
export class ShowstudentmattersListComponent implements OnInit, OnDestroy {
	// Table fields


    Element1: [{ id: "1" },
        { id: "2" }];
	displayedColumns = ['id', 'level_name', 'class_name', 'topic'];
	...
	editCustomer(customer: student_matters, student_mattersDataService: student_mattersDataService ) {
		...
		this.student_mattersDataService.GetAllstudent_matters_with_id(customer.id).subscribe(data => this.matters_info = data,
			...
			() => {
				...
				console.log('Component A is clicked!!', this.student_mattersDataService.id);
