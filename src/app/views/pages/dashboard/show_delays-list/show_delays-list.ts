...
@Component({
	...
	selector: 'kt-show-delays-list',
	templateUrl: './show_delays-list.html',
	changeDetection: ChangeDetectionStrategy.OnPush
	
	/*,providers: [DepartmentDataService]*/
})
export class ShowDelaysListComponent implements OnInit, OnDestroy {
	// Table fields


    Element1: [{ id: "1" },
        { id: "2" }];
	displayedColumns = ['delay_id', 'delay_emp_name', 'delay_date', 'time_attend'];
...
/*	dataSource: [{ "dep_id": 1, "dep_name": "main dep", "dep_desc": "asdasd", "dep_supervisor_id": 0, "dep_supervisor_name": "1", "parent_id": 1 }];*/
	...
	ngOnInit() {
		...
		this.DelaysDataService.bClickedEvent
