...
@Component({
	...
	selector: 'kt-borrowed-books-list',
	templateUrl: './borrowed_books-list.html',
	changeDetection: ChangeDetectionStrategy.OnPush
	
	/*,providers: [DepartmentDataService]*/
})
export class BorrowedBooksListComponent implements OnInit, OnDestroy {
	// Table fields


    Element1: [{ id: "1" },
        { id: "2" }];
	displayedColumns = ['borr_id', 'borr_date', 'lib_book_name', 'borr_name'];
