...
@Component({
	...
	selector: 'kt-week-ta7deirs-list',
	templateUrl: './week-Ta7diers-list.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush
	
	/*,providers: [DepartmentDataService]*/
})
export class week_Ta7deirComponent implements OnInit, OnDestroy {
	// Table fields


    Element1: [{ id: "1" },
        { id: "2" }];
	displayedColumns = ['select', 'ta7dier_id','civil_id','emp_dep','emp_name', 'ta7dier_date', 'subject_name', 'ta7dier_state_id', 'actions'];
...
/*	dataSource: [{ "dep_id": 1, "dep_name": "main dep", "dep_desc": "asdasd", "dep_supervisor_id": 0, "dep_supervisor_name": "1", "parent_id": 1 }];*/
	...
	get_ta7diers() {
		...
		this.ta7dier_masterDataService.get_ta7dier_master_for_dashboard_t2(this.decoded.id).subscribe(data => this.ELEMENT_DATA = data,
			error => console.log(error),
			() => {this.dataSource.data = this.ELEMENT_DATA; console.log("ta7deirrrr",this.ELEMENT_DATA)}
		); 
