...
@Component({
    ...
    templateUrl: './OtherStudentSlideComponent.html',
    changeDetection: ChangeDetectionStrategy.Default,

})
export class OtherStudentSlideComponent implements OnInit, AfterViewInit {
    public id: number;
    ...
    constructor(public _fb: FormBuilder,
        ...
        private DefinitionDataService: DefinitionDataService) {
            ...
            this.form1 = this._fb.group({
                ...
                slide_type: [[Validators.required]],
   ...
   updatedStudent:any;
    ...
    ngOnInit() {
        ...
        this.OtherStudentSlidesService.aClickedEvent
        .subscribe((data: string) => {
            if (Number(this.OtherStudentSlidesService.id) != 0) {
            ...
            this.class_id = this.OtherStudentSlidesService.class_id.toString();
            this.class_name = this.OtherStudentSlidesService.class_name;
            this.student_id = this.OtherStudentSlidesService.student_id.toString();
            this.student_name  = this.OtherStudentSlidesService.student_name;
            this.def_id = this.OtherStudentSlidesService.def_id.toString();
            this.s_code = this.OtherStudentSlidesService.s_code;
            this.selectedSlide = this.s_code;
            this.slide_type = this.OtherStudentSlidesService.slide_type;
            this.date_of_file_opening = this.OtherStudentSlidesService.date_of_file_opening;
