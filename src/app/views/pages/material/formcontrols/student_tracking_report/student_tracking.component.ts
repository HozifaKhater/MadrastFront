...
@Component({
    selector: 'kt-student_tracking_report',
    templateUrl: './student_tracking.component.html',
    changeDetection: ChangeDetectionStrategy.Default,

})
export class student_tracking_reportComponent implements OnInit, AfterViewInit {
    level: Levels[];
    selectedlevel: any;
    class: Classes[];
    selectedclass: any; 
...
console.log("this.student_trackingDataService",this.student_trackingDataService)
        this.student_trackingDataService.CClicked("test")
