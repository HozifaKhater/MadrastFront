...
import { nfsy_planDataService } from '../../../Services/nfsy_planDataService';
...
export class CalendartermsComponent implements OnInit {
  ...
  calendarPlugins = [dayGridPlugin,  timeGridPlugin, interactionPlugin, listPlugin];
    ...
    constructor(private modalService: NgbModal, private formBuilder: FormBuilder
        , private nfsy_planDataService: nfsy_planDataService) { }
   ...
   */
    onEventDrop(editcontent: any, event: any) {
        ...
        console.log("asd", val)
        this.nfsy_planDataService.updatenfsy_plan(val).subscribe(res => {
            alert(res.toString());
        })
  ...
  deleteEventData() {
    ...
    delete this.calendarEvents[deleteEvent].id;
      this.modalService.dismissAll();
      this.nfsy_planDataService.deletenfsy_plan(Number(deleteId)).subscribe(res => {
      })
  }
  ...
  saveEvent() {
    if (this.formData.valid) {
      ...
      console.log("asd", val)
      this.nfsy_planDataService.addnfsy_plan(val).subscribe(res => {
